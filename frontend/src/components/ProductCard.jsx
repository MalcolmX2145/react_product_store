...
const ProductCard = ({product}) => {
    const [updatedProduct, setUpdatedProduct] = useState(product); // remember previous values in the input fields
    const textColor = useColorModeValue("gray.800", "gray.200."); // light and dark mode
